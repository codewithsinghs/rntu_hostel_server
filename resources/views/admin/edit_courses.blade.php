            ...
            $.ajax({
                ...
                success: function (response) {
                    if (response.success && response.data) {
                        ...
                        $.ajax({
                            url: '/api/admin/departments?faculty_id=' + response.data.department
                                .faculty.id,
                            type: 'GET',
                            headers: {
                                'token': localStorage.getItem('token'),
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        if (response.success) {
                            ...
                            window.location.href =
                                "{{ route('admin.courses') }}"; // Redirect to faculties list
                        } else {
                    ...
                    error: function (xhr) {
                        if (xhr.status === 422) { // Validation error
                            ...
                            showAlert("danger",
                                "An error occurred while updating the courses.");
                        }
                    }
                });
            });

...
@section('content')
    ...
    <div class="top-breadcrumbs">
        <!-- breadcrumbs -->
        <div class="breadcrumbs"><a href="">Room Allocation Overview</a></div>
    </div>
    ...
    <section class="common-con-tainer">
        <div class="common-content">
            <div class="common-overview">
                <div class="breadcrumbs"><a>Room Allocation Details</a></div>
    ...
    <section class="common-con-tainer">
        <div class="common-content">
            <div class="common-overview">
                <div class="breadcrumbs"><a>All Room Change Pending Requests</a></div>

                <div class="overflow-auto">

                    <div id="mainResponseMessage" class="mt-3"></div>

                    <table class="status-table" id="leaveRequestList">
                        <thead>
                            <tr>
                                <th>S.No</th>
                                <th>Resident Name</th>
    ...
    <!-- Pending / Reject Request List Table -->
    <section class="common-con-tainer">
        <div class="common-content">
            <div class="common-overview">
                <div class="breadcrumbs"><a>Pending / Reject Request List</a></div>
                    ...
                    <table class="status-table">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>A-102</td>
                                <td>B-210</td>
                                <td>Room too noisy</td>
                                <td><span style="color: red;font-weight: 600;">High</span></td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>B-304</td>
                                <td>C-110</td>
                                <td>Closer to library</td>
                                <td><span style="color: orange;font-weight: 600;">Medium</span></td>
                                <td>
                                    <button class="green-btn" data-bs-toggle="modal"
                                        data-bs-target="#Approvepopup">Approve</button>
                                    <button class="delete-btn" data-bs-toggle="modal"
                            ...
                            <tr>
                                ...
                                <td>D-115</td>
                                <td>Health issues</td>
                                <td><span style="color: green;font-weight: 600;">Low</span></td>
                                <td>
                                    <button class="green-btn" data-bs-toggle="modal"
                                        data-bs-target="#Approvepopup">Approve</button>
                                    <button class="delete-btn" data-bs-toggle="modal"
    ...
    <!-- Room Allocation List Table -->
    <section class="common-con-tainer">
        <div class="common-content">
            <div class="common-overview">
                <div class="breadcrumbs"><a>Room Allocation List</a></div>
                    ...
                    <table class="status-table">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>Room too noisy</td>
                                <td><span style="color: red;font-weight: 600;">High</span></td>
                                <td><span style="color: green;font-weight: 600;">Approve</span></td>
                                <td>
                                    <button class="view-btn" data-bs-toggle="modal"
                                        data-bs-target="#viewpopup">View</button>
                                </td>
                            </tr>
                            <tr>
                                <td>2</td>
                                ...
                                <td>Closer to library</td>
                                <td><span style="color: orange;font-weight: 600;">Medium</span></td>
                                <td><span style="color: red;font-weight: 600;">Reject</span></td>
                                <td>
                                    <button class="view-btn" data-bs-toggle="modal"
                                        data-bs-target="#viewpopup">View</button>
                                </td>
    ...
    <button class="add-btn" type="button" data-bs-toggle="modal" data-bs-target="#chatModal">chatModal</button>
    <button class="add-btn" type="button" data-bs-toggle="modal" data-bs-target="#assignBedModal">assignBedModal</button>

    <!-- All Popup -->

    <div class="modal fade" id="Approvepopup" tabindex="-1" aria-labelledby="ApprovepopupLabel" style="display: none;"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="top">
                        <div class="pop-title">Room Change Request</div>
                    </div>
                    ...
                    <div class="middle">
                        ...
                        <span class="input-set">
                            <label for="ResidentName">Current Room No.</label>
                            <input type="text" id="ResidentName" name="ResidentName" placeholder="201" disabled>
                        </span>

                        <span class="input-set">
                            <label for="DesiredRoom">Desired Room No.</label>
                            <input type="text" id="DesiredRoom" name="DesiredRoom" placeholder="205" disabled>
                        </span>

                        <span class="input-set">
                            <label for="RequestDate">Request Date</label>
                            <input type="date" id="RequestDate" name="RequestDate" placeholder="20/02/25">
                        </span>
                    ...
                    <div class="full-width-i">
                        <span class="input-set">
                            ...
                            <textarea name="Reason" id="Reason"
                                placeholder="Lorem lorem Lorem loremLorem loremLorem loremLorem loremLorem loremLorem loremLorem loremLorem loremLorem  lorem"></textarea>
                        </span>
                    </div>
                    ...
                    <div class="full-width-i">
                        <span class="input-set">
                            ...
                            <textarea name="Reason" id="Reason"
                                placeholder="We are approve your request. Please contact us for further information "></textarea>
                        </span>
                    </div>
    ...
    <div class="modal fade" id="viewpopup" tabindex="-1" aria-labelledby="viewpopupLabel" style="display: none;"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="top">
                        <div class="pop-title">Room Change Details</div>
                    </div>
                    ...
                    <div class="middle">
                        ...
                        <span class="input-set">
                            ...
                            <input type="text" class="status-leave green" id="Status" name="Status" placeholder="Approve"
                                disabled="">
                        </span>
                    ...
                    <div class="full-width-i">
                        <span class="input-set">
                            <label for="Reason">Warden Message</label>
                            <textarea name="Reason" id="Reason"
                                placeholder="We are approve your request. Please contact us for further information "></textarea>
                        </span>
                    </div>
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="top">
                        <div class="pop-title">Final approval: Assign new bed to resident</div>
                    </div>

                    <div id="assignBedModalMessage" class="mt-3"></div>
                    ...
                    <form id="assignBedModalForm">
                        ...
                        <div class="middle">
                            ...
                            <span class="input-set">
                                <label for="modal_resident_id">Resident</label>
                                <select id="modal_resident_id" name="resident_id" required disabled>
                                    <option value=""> Resident Details </option>
                                </select>
                            </span>

                            <span class="input-set">
                                <label for="modal_building_id">Select Building</label>
                                <select id="modal_building_id" name="building_id" required>
                                    <option value="">Select Building</option>
                                </select>
                            </span>

                            <span class="input-set">
                                <label for="modal_room_id">Select Room</label>
                                <select id="modal_room_id" name="room_id" required>
                                    <option value="">Select Room</option>
                                </select>
                            </span>

                            <span class="input-set">
                                <label for="modal_bed_id">Select Bed</label>
                                <select id="modal_bed_id" name="bed_id" required>
                        ...
                        <div class="bottom-btn">
                            ...
                            <button type="submit" class="blue"> Assign Bed</button>
                        </div>

...
@section('content')
    ...
    <section class="common-con-tainer">
        <div class="common-content">
            <div class="common-overview">
                <div class="breadcrumbs"><a href="">Check-Out Details</a></div>
    ...
    <section class="common-con-tainer">
        <div class="common-content">
            <div class="common-overview">
                <div class="breadcrumbs"><a>Checkout Requests List</a></div>
                ...
                <div class="overflow-auto">
                    ...
                    <table class="status-table" id="checkoutRequestsTable">
                        <thead>
                            <tr>
                                <th>S.No</th>
                                <th>Resident Name</th>
    ...
    <button class="add-btn" type="button" data-bs-toggle="modal" data-bs-target="#accessoryModal">Accessory</button>
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="top">
                        <div class="pop-title">Resident Accessories</div>
                    </div>
                    ...
                    <div class="full-width-i">
                        <span class="input-set" id="accessoryModalBody">
                    ...
                    <div class="bottom-btn">
                        ...
                        <button type="submit" class="green" id="submitAccessoriesBtn"> Submit
                        </button>
                    </div>

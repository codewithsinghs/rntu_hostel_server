    ...
    <script>
            ...
            fetch(`{{ url('/api/admin/staff') }}/${staffId}`, {
                ...
                .then(data => {
                    ...
                    if (data.success) {
                        ...
                        document.getElementById("update_name").value = staff.name;
        ...
        document.addEventListener("DOMContentLoaded", function () {
            ...
            function getCsrfToken() {
                ...
                const csrfTokenField = document.getElementById('csrf_token_field_update');
                if (csrfTokenField) {
                    return csrfTokenField.value;
                } else {
                    console.error(
                        "CRITICAL ERROR: CSRF token hidden input field (id='csrf_token_field_update') not found. Ensure it's present in the form."
                    );

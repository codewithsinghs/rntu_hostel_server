...
<body>
    ...
    <div class="sidebar">
        ...
        <a href="{{ url('/resident/dashboard') }}" class="nav-link">
            <i class="fas fa-home"></i> Home Dashboard
        </a>

        <a href="{{ url('/resident/leave-request') }}" class="nav-link">
            <i class="fas fa-calendar-alt"></i> Submit Leave Request
        </a>

        <a href="{{ url('/resident/leave_request_status') }}" class="nav-link">
            <i class="fas fa-hourglass-half"></i> Track Leave Status
        </a>

        <a href="{{ url('/resident/room-change') }}" class="nav-link">
            <i class="fas fa-exchange-alt"></i> Request Room Change
        </a>

        <a href="{{ url('/resident/room_change_status') }}" class="nav-link">
            <i class="fas fa-home text-warning"></i> Room Change Status
        </a>

        <a href="{{ route('resident.submit_grievance') }}" class="nav-link">
            <i class="fas fa-exclamation-circle"></i> Submit Grievance
        </a>

        <a href="{{ url('/resident/grievance_status') }}" class="nav-link">
            <i class="fas fa-file-alt"></i> Grievance Status
        </a>

        <a href="{{ url('/resident/accessories') }}" class="nav-link">
            <i class="fas fa-tools"></i> Manage Accessories
        </a>

        <a href="{{ url('/resident/payment') }}" class="nav-link">
            <i class="fas fa-money-bill"></i> View Pending Payments
        </a>

        <a href="{{ url('/resident/feedback') }}" class="nav-link">
            <i class="fas fa-comment-dots"></i> Submit Feedback
        </a>

        <a href="{{ url('/resident/notices') }}" class="nav-link">
            <i class="fas fa-bell"></i> View Notices
        </a>

        <a href="{{ url('/resident/fine') }}" class="nav-link">
            <i class="fas fa-gavel text-danger"></i> Fine Payment Details
        </a>

        <!-- Optional: Subscription Management -->
        <!-- <a href="{{ url('/resident/subscription') }}" class="nav-link">
  <i class="fas fa-clipboard-list"></i> Manage Subscription
</a> -->

        <a href="{{ url('/resident/subscription_type') }}" class="nav-link">
            <i class="fas fa-list-alt"></i> Subscription Options
        </a>

        <a href="{{ route('resident.checkout') }}" class="nav-link">
            <i class="fas fa-door-open"></i> Initiate Checkout
        </a>

        <a href="{{ route('resident.checkout.status') }}" class="nav-link">
            <i class="fas fa-clipboard-check"></i> Checkout Status
        </a>

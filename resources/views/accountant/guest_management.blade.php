                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3 " style="display:none;">
                            ...
                            <small class="form-text text-muted">This field is calculated and cannot be directly
                                edited.</small>
                        </div>
    ...
    <script>
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            function fetchGuestsForAccountant() {
                ...
                guestList.innerHTML =
                    `<tr><td colspan="8" class="text-center">Loading guests...</td></tr>`; // Updated colspan
                ...
                fetch("{{ url('/api/accountant/guests/pending') }}", {
                    ...
                    .then(response => {
                        ...
                        if (!response.success || !Array.isArray(guests) || guests.length === 0) {
                            guestList.innerHTML =
                                `<tr><td colspan="8" class="text-center">No guests found.</td></tr>`; // Updated colspan
                        ...
                        guests.forEach((guest, index) => { // Added index for Serial No
                            ...
                            if (guest.attachment_path) {
                                attachmentLink =
                                    `<a href="{{ asset('storage/') }}/${guest.attachment_path}" target="_blank" class="btn btn-sm btn-secondary">View</a>`;
                            }
                    ...
                    .catch(error => {
                        ...
                        guestList.innerHTML =
                            `<tr><td colspan="8" class="text-center text-danger">Failed to load guests.</td></tr>`; // Updated colspan

                    ...
                    //                     `;
...

                        {
                            ...
                            render: function(data, type, row) {
                                ...
                                // ✅ Admin buttons
                                if ( (CURRENT_USER_ROLE?.includes('admin') || CURRENT_USER_ROLE?.includes('warden')) && row.hod_status === 'approved' && row.admin_status === 'pending' ) {
                                    html += `
                                                <div class="mt-1">
                                                    <button class="btn btn-sm btn-success me-1"
            ...
            $.ajax({
                ...
                success: res => {
                    ...
                    if (c.approvals && Array.isArray(c.approvals)) {
                        ...
                        // const warden = c.approvals.find(a => a.role.toLowerCase() === 'warden');

        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    {{-- <div id="checkoutLifecycleSection" class="d-none mb-4">
                        ...
                        <div class="card border-0 shadow-sm">
                            <div class="card-body">
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    <div>
                                        <h5 id="viewStatusLabel" class="mb-1"></h5>
                                        <small id="viewStatusDescription" class="text-muted"></small>
                                    </div>
                                    <span id="viewStatusBadge" class="badge px-3 py-2"></span>
                                </div>
                                ...
                                <div class="row text-center mt-3">
                                    <div class="col-md-3">
                                        ...
                                        <h6 id="viewTotalInvoices" class="fw-bold"></h6>
                                    </div>
                                    <div class="col-md-3">
                                        <small class="text-muted">Paid</small>
                                        <h6 id="viewTotalPaid" class="fw-bold text-success"></h6>
                                    </div>
                                    <div class="col-md-3">
                                        <small class="text-muted">Pending</small>
                                        <h6 id="viewPendingDues" class="fw-bold text-danger"></h6>
                                    </div>
                                    <div class="col-md-3">
                                        <small class="text-muted">Net Position</small>
                                        <h6 id="viewNetPosition" class="fw-bold"></h6>
                                    </div>
                                </div>
                                ...
                                <div>
                                    <h6 class="mb-2">Checkout Progress</h6>
                                    <ul id="viewTimeline" class="list-group list-group-flush"></ul>
                                </div>
                    ...
                    {{-- <div id="checkoutSummarySection" class="d-none mb-4">
                        ...
                        <div class="card shadow-sm border-0">
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex justify-content-between align-items-start flex-wrap">
                                    ...
                                    <div>
                                        <h5 id="summaryTitle" class="mb-1 fw-bold"></h5>
                                        <p id="summaryMessage" class="text-muted mb-0"></p>
                                    </div>

                                    <div>
                                        <span id="summaryBadge" class="badge px-3 py-2 fs-6"></span>
                                    </div>
                                ...
                                <!-- FINANCIAL BLOCK -->
                                <div id="financialBlock" class="mt-3">
                                    ...
                                    <div id="financialNotice" class="alert mt-4 d-none"></div>
                                ...
                                <!-- PROCESS TIMELINE -->
                                <div>
                                    <h6 class="mb-3">Checkout Process</h6>
    ...
    <div class="modal fade" id="leaveActionModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog">
            <form id="leaveActionForm" enctype="multipart/form-data">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="leaveActionTitle">CheckOut Action</h5>

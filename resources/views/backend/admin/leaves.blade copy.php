    ...
    @push('scripts')
                        ...
                        columns: [{
...

                            {
                                ...
                                render: function(data, type, row) {
                                    let name = row.resident?.name || '<span class="text-muted">N/A</span>';
                                    let scholarNo = row.resident?.scholar_no ||
                                        '<span class="text-muted">N/A</span>';
                                    let room = row.resident?.room_number ||
                                        '<span class="text-muted">N/A</span>';
                                    let bed = row.resident?.bed_number ||
                                        '<span class="text-muted">N/A</span>';
        ...
        `;
                            ...
                            // },
                            {
                                ...
                                title: 'Leave Details',
                                render: function(data, type, row) {
                                    let leaveType = row.leave_type || '<span class="text-muted">N/A</span>';

...
@section('content')
                ...
                <div class="row g-4 mb-4">
                    ...
                    <div class="col-md-6">
                        <div class="card shadow-sm h-100">
                            ...
                            <div class="d-flex flex-wrap" id="default-accessories">
                    ...
                    <div class="col-md-6">
                        <div class="card shadow-sm h-100">
                            ...
                            <div class="d-flex flex-wrap" id="additional-accessories">
  ...
  <div class="card-header bg-primary text-white">
    <h5 class="mb-0">Fee & Accessory Breakdown</h5>
  </div>
  <div class="card-body">
    <table class="table table-bordered table-sm">
      ...
      <tfoot>
        <tr class="table-secondary">
          ...
          <td id="breakdown-total"><strong>₹0</strong></td>
        </tr>
      </tfoot>
    </table>
  </div>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $.ajax({
                ...
                dataType: 'json',
                data: JSON.stringify({ months, accessory_ids: accessoryIds }),
                headers: {
                'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content'),
                'token': localStorage.getItem('token'),
                'auth-id': localStorage.getItem('auth-id')
                ...
                error: function() {
                $('#fee-breakdown').html('<div class="alert alert-danger">Failed to load fee info.</div>');
                }
            });
            }

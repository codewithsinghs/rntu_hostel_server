        ...
        $.ajax({
            ...
            success: function (response) {
                if (response.success) {
                    ...
                    console.log("Building data received:", building);
                    ...
                    if(building.gender && building.gender.toLowerCase() !== ''){
                        if(building.gender.toLowerCase() === 'male') {
                            $('#male').prop('checked', true);
                        } else if(building.gender.toLowerCase() === 'female') {
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.success) {
                        ...
                        setTimeout(function() {
                            window.location.href = '/warden/buildings';
                        }, 1500);
                    } else {

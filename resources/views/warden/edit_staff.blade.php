        ...
        if (data.success) {
            ...
            if (Array.isArray(staff.building_id)) {
                staff.building_id.forEach(buildingId => {
                    $(`input[name='buildings[]'][value='${buildingId}']`).prop("checked", true);
                });
            }
            else
            {
            ...
            .then(response => {
                ...
                if (response.success && Array.isArray(buildings)) {
                    buildings.forEach(building => {
                        buildingSelect.innerHTML += `<label class="checkbox-wrapper"><input type="checkbox" name="buildings[]" value="${building.id}"><span class="checkmark"></span>${building.name}</label>`;
                    });
                } else {
